  ...
  return (
    <div className="shopProductElement">
      <div className="shopProductElementContainer">
        <div
          className="shopProductElementContainerDiv"
              ...
              <div className="shopProductElementContainerDivTopContainerImageOne">
                <div className="shopProductElementContainerDivTopContainerImageOneContainer">
                  <img
                    ...
                    alt={product.name}
                    className="shopProductElementContainerDivTopContainerImageOneContainerImage"
                  />
                </div>
              </div>
              <div className="shopProductElementContainerDivTopContainerImageTwo">
                <div className="shopProductElementContainerDivTopContainerImageTwoContainer">
                  <img
                    ...
                    alt={product.name}
                    className="shopProductElementContainerDivTopContainerImageTwoContainerImage"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="shopProductElementContainerDivBottom">
            <div className="shopProductElementContainerDivBottomContainer">
              ...
              <div className="shopProductElementContainerDivBottomContainerThird">
                <div className="shopProductElementContainerDivBottomContainerThirdContainer">
                  {" "}
                  {/* Left Part */}
                  <div className="shopProductElementContainerDivBottomContainerThirdContainerLeft">
                    <div
                      className="shopProductElementContainerDivBottomContainerThirdContainerLeftContainer"
                  ...
                  <div className="shopProductElementContainerDivBottomContainerThirdContainerRight">
                    <div
                      className="shopProductElementContainerDivBottomContainerThirdContainerRightContainer"
                    ...
                    >
                      ...
                      <div className="shopProductElementContainerDivBottomContainerThirdContainerRightContainerTwo">
