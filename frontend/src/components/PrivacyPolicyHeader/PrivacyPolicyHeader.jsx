            ...
            <div className="privacyPolicyHeaderContainerBottom">
                <div className="privacyPolicyHeaderContainerBottomContainer">
                    <p className="privacyPolicyHeaderContainerBottomContainerText nunito-sans-regular">
                        This Privacy Policy governs the manner in which THE-LOWDOWN.com collects, uses, maintains and discloses information collected from users (each, a “User”) of the www.the-lowdown.com website (“Site”). This privacy policy applies to the Site and all products and services offered by THE-LOWDOWN.com.
                    </p>
                </div>
            </div>
