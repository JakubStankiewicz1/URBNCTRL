...
const Cart = () => {
    const { cart, removeFromCart, updateQuantity, getCartTotal, clearCart } = useProducts();
            ...
            <div className="cart">
                <div className="cartContainer">
                    <div className="cartEmpty">
                        <h1 className="cartEmptyTitle nunito-sans-regular">Your Cart is Empty</h1>
            ...
            <div className="cartContainer">
                    ...
                    {cart.map((item) => (
                        <div key={item.id} className="cartTableRow">
                            <div className="cartTableCell product">
                                <div className="productInfo">
                                    ...
                                    <div className="productDetails">
                                        ...
                                        {item.selectedSize && (
                                            <p className="productSize nunito-sans-regular">Size: {item.selectedSize}</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="cartTableCell price">
                                <span className="nunito-sans-regular">{formatPrice(item.price)}</span>
                            </div>
                            ...
                            <div className="cartTableCell quantity">
                                <div className="quantityControls">
                                    ...
                                    <span className="quantityValue nunito-sans-regular">{item.quantity}</span>
                                    <button 
                                        className="quantityButton"
                                        onClick={() => handleQuantityChange(item.id, item.quantity + 1)}
                                    >
                            ...
                            <div className="cartTableCell subtotal">
                                <span className="nunito-sans-regular">{formatPrice(item.price * item.quantity)}</span>
                            </div>
                ...
                <div className="cartTotals">
                    ...
                    <div className="cartTotalsRow">
                        ...
                        <span className="nunito-sans-regular">{formatPrice(getCartTotal())}</span>
                    </div>
                    
                    <div className="cartTotalsRow">
                        <span className="nunito-sans-regular">Shipping</span>
                        <div className="shippingInfo">
                            <span className="nunito-sans-regular">International (Express Service): <strong className="shippingPrice">$10</strong></span>
                            <p className="shippingLocation nunito-sans-regular">Shipping to <strong>Poland</strong>.</p>
                            <Link to="#" className="changeAddress nunito-sans-regular">Change address 🏠</Link>
                        </div>
                    </div>
                    
                    <div className="cartTotalsRow total">
                        <span className="nunito-sans-regular">Total</span>
                        <span className="nunito-sans-regular">{formatPrice(getCartTotal() + 10)}</span>
                    </div>

                    <div className="afterpayInfo nunito-sans-regular">
                        or 4 interest-free payments of {formatPrice((getCartTotal() + 10) / 4)} with 
